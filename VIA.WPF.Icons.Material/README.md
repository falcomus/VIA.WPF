...
Optional Material icon controls and markup extensions for VIA.WPF.

## Package reference

```xml
<PackageReference Include="VIA.WPF.Icons.Material" Version="1.0.0" />
```
