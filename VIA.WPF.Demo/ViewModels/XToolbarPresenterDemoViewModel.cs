// --------------------------------------------------------------------------------------------------------------------
// <copyright file="XToolbarPresenterDemoViewModel.cs" company="VIA.WPF">
...
#region ### Class XToolbarPresenterDemoViewModel ###
/// <summary>
/// Represents the demo view model for the XHeaderBar showcase page.
/// </summary>
public sealed partial class XToolbarPresenterDemoViewModel : DemoPageViewModel
{
    ...
    #region ### Constructors ###
    /// <summary>
    /// Initializes a new instance of the <see cref="XToolbarPresenterDemoViewModel"/> class.
    /// </summary>
    public XToolbarPresenterDemoViewModel()
    {
    ...
    /// <inheritdoc/>
    public override string Description => "Demonstrates the standard workbench header with breadcrumb, contextual groups and arbitrary actions.";
...
<via:XHeaderBar Title="Projects" Subtitle="12 active projects">
    <via:XHeaderBar.Actions>
        <via:XStackPanel Orientation="Horizontal" Spacing="6">
            <via:XButton Content="New" Size="Small" />
            <via:XButton Appearance="Ghost" Content="Refresh" Size="Small" />
            <via:XMoreButton />
        </via:XStackPanel>
    </via:XHeaderBar.Actions>

    <via:XHeaderGroup Header="Search">
        <via:XSearchBox Width="260" Placeholder="Search projects" />
    </via:XHeaderGroup>
</via:XHeaderBar>
""";
